...
regmap_register_t regmap_registers[] =
  {
    ...
    /* Interlaken */
    { REG_INTERLAKEN_PACKET_LENGTH,
      "Full Register",
      0x05000,
      REGMAP_REG_READ|REGMAP_REG_WRITE,
      REGMAP_ENDPOINT_0
    },
    { REG_INTERLAKEN_CONTROL_STATUS,
      "Full Register",
      0x05010,
      REGMAP_REG_READ|REGMAP_REG_WRITE,
      REGMAP_ENDPOINT_0
...
regmap_bitfield_t regmap_bitfields[] =
  {
    ...
    /* Interlaken */
    { BF_INTERLAKEN_PACKET_LENGTH,
      "Packet length for fromhost packet (to Interlaken)",
      0x05000,
      0x000000000000FFFF,
      0,
      15,
    ...
    { BF_INTERLAKEN_CONTROL_STATUS_TRANSCEIVER_RESET,
      "Any write to this register triggers a transceiver reset",
      0x05010,
      0x0000000000000000,
      0,
      -1,
    ...
    { BF_INTERLAKEN_CONTROL_STATUS_DECODER_LOCK,
      "Decoder lock indication",
      0x05010,
      0x0000000000000002,
      1,
      1,
    ...
    { BF_INTERLAKEN_CONTROL_STATUS_DESCRAMBLER_LOCK,
      "Descrambler lock indication",
      0x05010,
      0x0000000000000001,
      0,
      0,
