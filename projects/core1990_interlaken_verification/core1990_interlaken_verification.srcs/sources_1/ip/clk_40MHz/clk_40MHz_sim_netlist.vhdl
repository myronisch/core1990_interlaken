...
--               /home/leover/Desktop/Core1990_Verification/projects/core1990_interlaken_verification/core1990_interlaken_verification.srcs/sources_1/ip/clk_40MHz/clk_40MHz_sim_netlist.vhdl
-- Design      : clk_40MHz
...
entity clk_40MHz_clk_40MHz_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of clk_40MHz_clk_40MHz_clk_wiz : entity is "clk_40MHz_clk_wiz";
end clk_40MHz_clk_40MHz_clk_wiz;

architecture STRUCTURE of clk_40MHz_clk_40MHz_clk_wiz is
  signal clk_in1_clk_40MHz : STD_LOGIC;
  signal clk_out1_clk_40MHz : STD_LOGIC;
  signal clk_out2_clk_40MHz : STD_LOGIC;
  signal clkfbout_buf_clk_40MHz : STD_LOGIC;
  signal clkfbout_clk_40MHz : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clkfbout_clk_40MHz,
      O => clkfbout_buf_clk_40MHz
    );
...
entity clk_40MHz is
  ...
  attribute NotValidForBitStream of clk_40MHz : entity is true;
end clk_40MHz;

architecture STRUCTURE of clk_40MHz is
begin
inst: entity work.clk_40MHz_clk_40MHz_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
