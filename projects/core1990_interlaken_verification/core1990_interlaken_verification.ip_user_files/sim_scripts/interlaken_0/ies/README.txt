...
#
# Generated by export_simulation on Wed Mar 13 10:42:09 CET 2019
#
################################################################################
...
'-reset_run' switch to the './interlaken_0.sh' script.

./interlaken_0.sh -reset_run
...
./interlaken_0.sh -noclean_files

For more information on the script, please type './interlaken_0.sh -help'.
