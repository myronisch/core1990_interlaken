...
elaborate()
{
  xelab --relax --debug typical --mt auto -L fifo_generator_v13_2_2 -L work -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RX_FIFO work.RX_FIFO work.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RX_FIFO.wdb xsim.dir)
