...
HD_PWD='/home/leover/Desktop/Core1990_Verification/projects/core1990_interlaken_verification/core1990_interlaken_verification.runs/interlaken_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interlaken_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interlaken_0.tcl
