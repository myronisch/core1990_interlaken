...
HD_PWD='/home/leover/Desktop/Core1990_Verification/projects/core1990_interlaken_verification/core1990_interlaken_verification.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Core199_verification.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Core199_verification.tcl
